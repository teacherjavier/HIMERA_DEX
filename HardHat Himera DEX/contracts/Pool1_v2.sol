...
contract Pool1 {
    ...
    LP1_token public lpToken; // The LP token for this pool
    ...
    constructor(address _tokenA, address _tokenB, address payable _farm) {
        ...
        lpToken = new LP1_token(address(this));
    }
    ...
    function addLiquidity(uint256 amountA, uint256 amountB) external {
        ...
        farm.registerLP1Holder(msg.sender);
    ...
    function removeLiquidity(uint256 shares) external {
        ...
        if (newBalance == 0) {
            farm.unregisterLP1Holder(msg.sender);
        }
